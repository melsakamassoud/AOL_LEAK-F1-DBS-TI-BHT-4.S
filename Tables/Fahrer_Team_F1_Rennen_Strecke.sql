...
('Red Bull Racing'),
('BMW Sauber F1 Team'),
('Midland F1 Racing / Spyker MF1 Team'), 	-- Selbest team!
--('Spyker MF1 Team'), -- wie
('Scuderia Toro Rosso'),
...
FROM (VALUES
  ...
  ('Tiago Monteiro',         'Midland F1 Racing / Spyker MF1 Team'),             -- das Team hieß bis Ungarn MF1 Racing, danach Spyker
  ('Christijan Albers',      'Midland F1 Racing / Spyker MF1 Team'),             -- gleicher Team-Name wie oben gewünscht
